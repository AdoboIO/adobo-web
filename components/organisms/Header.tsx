...
import {ChevronDownIcon, PhoneIcon, PlayCircleIcon, PlayIcon} from "@heroicons/react/20/solid";
import {
    ArrowPathIcon,
    Bars3Icon,
    ChartPieIcon,
        ...
        <header className="bg-white">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12">
                    ...
                    <HeaderLinkText name="Features" href="#"/>
                    <HeaderLinkText name="Marketplace" href="#"/>
                    <HeaderLinkText name="Company" href=""/>
                </Popover.Group>
